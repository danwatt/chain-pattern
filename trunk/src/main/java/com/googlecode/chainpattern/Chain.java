 ...
 * included {@link Command} will be executed in turn, until either one of them
 * returns <code>true</code>, one of the executed {@link Command}s throws an
 * exception, or the end of the chain has been reached. The {@link Chain} itself
 * will return the return value of the last {@link Command} that was executed
...
public interface Chain<C> extends Command<C> {
	 ...
	 * of this {@link Context} has been completed, or <code>false</code> if none
	 * of the called {@link Command}s returned <code>true</code>.</li>
	 * </ul>
	 * 
	 * @param context
